...
class Graph(BaseModel, Generic[NodeType]):
    ...
    # TODO: this is not faster. Either remove the deepcopy, or find expensive operations
    def fast_min_cut(self):
